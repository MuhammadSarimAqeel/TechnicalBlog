  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link " href="profile.jsp" tabindex="-1" aria-disabled="true" ><span class="fa fa-mail-reply"></span> Go To Main Page</a>
      </li>
...
postdao d = new postdao(ConnectionProvider.getConnection());
	...
	posts = d.getPostsByUserID(userId);
...
%>
<h6 class="post user info"><b><%= udao.getUserByUserId(p.getUserid()).getName() %></b>  Posted it on : <%= p.getpDate().toLocaleString() %></h6>
</div>
<div class="col-md-4">
<h6></h6>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="myposts.jsp">See Your Posts Here</a></td>
