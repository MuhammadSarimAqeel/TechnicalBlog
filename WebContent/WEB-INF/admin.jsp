...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="index.jsp"><span class="	fa fa-bank"></span>Coding World</a>
 ...
 %>
       ...
       <li class="nav-item">
        <a class="nav-link " href="#" tabindex="-1" aria-disabled="true" data-toggle="modal" data-target="#AddPostModal"><span class="fa fa-plus-square"></span> Add Category</a>
      </li>
 ...
 <li>
  ...
  <a href="LogoutServlet"  class="btn btn-outline-light btn-lg"> Logout 
</a> 
